<?php
/* *
 * 功能：支付宝统一下单并支付页面接口接口调试入口页面
 * 版本：3.3
 * 日期：2012-07-23
 * 说明：
 * 以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己网站的需要，按照技术文档编写,并非一定要使用该代码。
 */
//生成商家订单号，YYYYmmddHHiiss+4位随机数
...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝统一下单并支付页面接口快速通道</span>
		</div>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="out_trade_no" value="<?php echo $out_trade_no ?>" />
                        <span>必填</span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="subject" value="<?php echo $subject ?>" />
                        <span>必填</span>
                    </dd>
                    <dt>订单金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="total_fee" value="<?php echo $total_fee ?>" />
                        <span>必填</span>
                    </dd>
